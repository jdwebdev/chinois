...
class Hanzi {
    ...
    static bushouList = [
        ...
        {nb:3,key:["宀","艹","囗","口","门","子","小","大","马","山","巾","弓","辶","扌","彳","尢","尸","氵","工","士","土","夕","纟","干","彐","寸","犭","己","飞","饣","广","女","夂","廾","彡","巳","川"]},
        {nb:4,key:["王","车","木","礻","火","灬","日","曰","文","月","水","长","戈","心","气","耂","父","贝","见","牛","牜","攵","支","比","爫","欠","片","止","户","斤","手","风","歹","韦","瓦","毛","牙","氏"]},
        {nb:5,key:["钅","衤","穴","疒","白","白","田","矢","石","母","目","立","龙","生","鸟","癶","罒","玉","禾","皿"]},
        {nb:6,key:["衣","⺮","自","糸","米","覀","肉","舌","页","虫","舟","行","耳","色","羽","虍","羊"]},
        {nb:7,key:["足","走","酉","里","辛","身","角"]},
        {nb:8,key:["非","鱼","雨","隹","青","齿"]},
        {nb:9,key:["面","音","首","香"]},
        {nb:10,key:["高"]},
        {nb:11,key:["麻","黄"]},
        {nb:12,key:["黑"]},
    ...
    /*
        ...
        宀艹囗口门子小大马山巾弓辶扌彳尢尸氵工士土夕纟干彐寸犭己飞饣广女夂廾彡巳川
        王车木礻火灬日曰文月水长戈心气耂父贝见牛牜攵支比爫欠片止户斤手风歹韦瓦毛牙氏
