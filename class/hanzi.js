...
class Hanzi {
    ...
    static bushouList = [
        ...
        {nb:3,key:["宀","艹","囗","口","门","子","小","大","马","山","巾","弓","辶","扌","彳","尢","尸","氵","工","士","土","夕","纟","干","彐","寸","犭","己","飞","饣","广","女","夂","廾","彡","巳","川","弋"]},
        ...
        {nb:6,key:["衣","⺮","自","糸","米","覀","肉","舌","页","虫","舟","行","耳","色","羽","虍","羊","而","至"]},
    ...
    /*
        ...
        宀艹囗口门子小大马山巾弓辶扌彳尢尸氵工士土夕纟干彐寸犭己飞饣广女夂廾彡巳川弋
