...
class Hanzi {
    ...
    static bushouList = [
        ...
        {nb:5,key:["钅","衤","穴","疒","白","白","田","矢","石","母","目","立","龙","生","鸟","癶","罒","玉","禾","皿","瓜","皮","矛"]},
        {nb:6,key:["衣","⺮","自","糸","米","覀","肉","舌","页","虫","舟","行","耳","色","羽","虍","羊","而","至","艮","缶","齐","血","臼"]},
        {nb:7,key:["足","走","酉","里","辛","身","角","豕","豆","豸"]},
    ...
    /*
        ...
        钅衤穴疒白白田矢石母目立龙生鸟癶罒玉禾皿瓜皮矛
        衣⺮自糸米覀肉舌页虫舟行耳色羽虍羊而至艮缶齐血臼
        足走酉里辛身角豕豆豸
        非鱼雨隹青齿采隹
        面音首香鬼革髟
        高
