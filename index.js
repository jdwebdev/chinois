	...
	popup_help.innerHTML = `
        <div id="help_container">
            <div id="help_content">
                ...
                <p class="date zh_font">2025年3月2日<span class="app_version zh_font">V. 6.7</span></p>
                <h2 class="help_title">Ajout de la leçon MC3-3</h2>
                ...
                <p class="date zh_font">2024年10月16日<span class="app_version zh_font">V. 6.3</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-13</h2>
                ...
                <p class="date zh_font">2024年9月23日<span class="app_version zh_font">V. 6.0</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-10</h2>

                <p class="date zh_font">2024年9月17日<span class="app_version zh_font">V. 5.9</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-9</h2>

                <p class="date zh_font">2024年9月13日<span class="app_version zh_font">V. 5.8</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-8</h2>

                <p class="date zh_font">2024年9月10日<span class="app_version zh_font">V. 5.7</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-7</h2>

                <p class="date zh_font">2024年9月2日<span class="app_version zh_font">V. 5.6</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-6</h2>

                <p class="date zh_font">2024年8月27日<span class="app_version zh_font">V. 5.5</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-5</h2>

                <p class="date zh_font">2024年8月15日<span class="app_version zh_font">V. 5.4</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-4</h2>

                <p class="date zh_font">2024年8月6日<span class="app_version zh_font">V. 5.3</span></p>
                <h2 class="help_title">Ajout de la leçon MC2-3</h2>
